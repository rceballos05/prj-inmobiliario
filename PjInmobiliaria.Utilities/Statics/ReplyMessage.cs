namespace PjInmobiliaria.Utilities.Statics
{
    public class ReplyMessage
    {
        ...
        public const string MESSAGE_ACTIVATE = "Se activó el registro";
        public const string MESSAGE_TOKEN = "Se generó el token correctamente";
        public const string MESSAGE_VALIDATION = "Error en la validación";
